...
<body bgcolor="skyblue">
	...
	echo "<option value='$brand_id'>$brand_title</option>";
			...
			<tr>
				...
				<td><input type="file" name="product_image" /></td><br>
				<td>pro image 1<input type="file" name="product_image1" /></td><br>
				<td>pro image 2<input type="file" name="product_image2" /></td><br>
				<td>pro image 3<input type="file" name="product_image3" /></td><br>
				<td>pro image 4<input type="file" name="product_image4" /></td><br>
			</tr>
